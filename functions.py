...
def read_player_from_csv(csv_file):
    """
    This function reads player data from csv file and returns a dictionary with email as the key
...
def write_player_data_to_csv(csv_filename, email,):
    """
...
if __name__ == '__main__':
    # write_player_data_to_csv("", "helen3test@email.com")
    # result = read_player_from_csv("string")
    # print(result)
    register_user("ini", "test", "initest@gmail.com", "password123", "6390000000", "26-01-2004", "Saskatoon", "SK")
